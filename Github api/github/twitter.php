...
if (isset($_POST['twitter'])) {
 ...
 /*   echo "<pre>";
  ...
  /*   echo "<pre>";
   ...
   echo $file_name_1 = $final_url_1['0']['0']['name'];
   echo"<br>";
   echo $file_name_2 = $final_url_1['0']['1']['name'];
   echo"<br>";
   echo $file_name_3 = $final_url_1['0']['2']['name'];
   echo"<br>";
   $file_1 = $final_url_1['0']['0']['download_url'];
   $file_2 = $final_url_1['0']['1']['download_url'];
   $file_3 = $final_url_1['0']['2']['download_url'];
  ...
  $file = fopen(__DIR__ . '/twitter/Doc.html', "a");
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_HTTPHEADER, $header1);
    curl_setopt($ch, CURLOPT_URL, $file_1);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
   ...
   curl_setopt($ch, CURLOPT_FILE, $file);
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_HTTPHEADER, $header1);
    curl_setopt($ch, CURLOPT_URL, $file_2);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
	curl_setopt($ch, CURLOPT_TIMEOUT, 15);
curl_setopt($ch, CURLOPT_FILE, $file);
    $output          = curl_exec($ch);
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_HTTPHEADER, $header1);
    curl_setopt($ch, CURLOPT_URL, $file_3);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
	curl_setopt($ch, CURLOPT_TIMEOUT, 15);
   curl_setopt($ch, CURLOPT_FILE, $file);
    $output          = curl_exec($ch);
	...
	fclose($file);  
/* $get_content = file_get_contents(__DIR__ . '/twitter/index.php');
$json = json_encode($get_content, true);
$get_content; */	
}

$dir    = 'twitter';
$files = scandir($dir);
$_SESSION['files_1'] = $files_1 = $files['2']; 
$_SESSION['files_2'] = $files_2 = $files['3']; 
$_SESSION['files_3'] = $files_3 = $files['4'];  
?>
<center>
<h1> Click here to download the files </h1>
<form action="download.php"  method="POST">
<input name="file1" type="submit" value="<?php echo $_SESSION['files_1']; ?>" ></input>
<input name="file2" type="submit" value="<?php echo $_SESSION['files_2']; ?>" ></input>
<input name="file3" type="submit" value="<?php echo $_SESSION['files_3']; ?>" ></input>
</form>
</center>